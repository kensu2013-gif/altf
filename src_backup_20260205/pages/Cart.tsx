    ...
    const handleUpdate = <K extends keyof LineItem>(id: string, field: K, value: LineItem[K]) => {
        ...
        if (['name', 'thickness', 'size', 'material'].includes(field as string)) {
            ...
            if (match) {
                ...
                updates.markingWaitQty = match.markingWaitQty;
                ...
                updates.markingWaitQty = undefined;
                        ...
                        >
                            <div className="overflow-x-auto">
                                <table className="w-full text-sm text-left">
                                    <thead className="bg-slate-50/80 text-slate-700 border-b-2 border-slate-300 backdrop-blur-sm">
                                        <tr>
                                            ...
                                            <th className="px-1 py-3 border-r border-slate-200/60 text-center w-[50px]">
                                                <span className="text-sm font-extrabold text-slate-800">No.</span>
                                            </th>
                                            <th className="px-1 py-3 border-r border-slate-200/60 text-center w-[130px]">
                                            ...
                                            <th className="px-1 py-3 border-r border-slate-200/60 text-center w-[80px]">
                                                <div className="flex flex-col items-center justify-center leading-tight">
                                            ...
                                            <th className="px-1 py-3 border-r border-slate-200/60 text-center w-[120px]">
                                                <div className="flex flex-col items-center justify-center leading-tight">
                                            ...
                                            <th className="px-1 py-3 border-r border-slate-200/60 text-center w-[90px]">
                                                <div className="flex flex-col items-center justify-center leading-tight">
                                                    <span className="text-sm font-extrabold text-slate-800">재고</span>
                                                    <span className="text-[11px] font-bold text-slate-400">STOCK</span>
                                                </div>
                                            </th>
                                            <th className="px-1 py-3 border-r border-slate-300/60 text-center w-[120px]">
                                                <div className="flex flex-col items-center justify-center leading-tight">
                                            ...
                                            <th className="px-1 py-3 border-r border-slate-200/60 text-center w-[100px]">
                                                <div className="flex flex-col items-center justify-center leading-tight">
                                            ...
                                            {items.map((item, index) => {
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <td className="px-1 py-3 text-center border-r border-slate-200 font-bold text-slate-500">
                                                            {index + 1}
                                                        </td>
                                                        ...
                                                        <td className="px-3 py-3 text-center border-r border-slate-200 bg-slate-50/30">
                                                            <div className="flex flex-col items-center gap-2">
                                                                ...
                                                                {item.markingWaitQty !== undefined && item.markingWaitQty > 0 && (
                                                                    <Badge color="purple" className="bg-indigo-50 text-indigo-700 px-2 py-0.5 text-[10px] border border-indigo-200 shadow-sm font-bold animate-pulse">
                                                                        마킹대기중 {item.markingWaitQty}개
                                                                    </Badge>
                                                                )}
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td className="p-0 border-r border-slate-200 bg-white group-hover:bg-white/50 transition-colors">
                                                            <div className="flex flex-col justify-center h-full">
                                                                ...
                                                                {(item.currentStock !== undefined && item.quantity > (item.currentStock + (item.markingWaitQty || 0))) && (
                                                                    <div className="text-rose-500 text-[9px] font-bold pb-1 text-center tracking-tighter w-full bg-rose-50/50">
                                                                        재고보다 많아요.
                                                                    </div>
                                                                )}
                                                            </div>
                                    ...
                                    <tfoot className="bg-slate-50/90 border-t border-slate-200 backdrop-blur-sm">
                                        <tr>
                                            ...
                                            <td colSpan={9} className="px-4 py-4 text-right text-slate-500 font-extrabold text-sm uppercase tracking-wide">
                                                총 합계금액(부가세 제외)
                                            </td>
                                ...
                                <div className="flex items-center">
                                    {selectedIds.length > 0 && (
                                        <Button
                                            ...
                                            className="text-red-500 hover:text-red-700 hover:bg-red-50 gap-2 font-bold px-4 h-12"
                                        >
