...
export default function Customers() {
    ...
    // 1. Company Analytics Engine (Regional/Client Sales Analytics)
    ...
    // 2. Strategy Analytics Engine (Advanced BI Strategy Analytics)
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500 pb-20">
            ...
            <div className="flex items-center gap-2 border-b border-slate-200 pb-2">
                ...
                >
                    <BarChart2 className="w-4 h-4 inline mr-2"/>
                    Regional/Client Sales Analytics
                </button>
                <button 
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-left text-sm whitespace-nowrap">
                                ...
                                <tbody className="divide-y divide-slate-100">
                                    ...
                                    {filtered.length === 0 && (
                                        <tr>
                                            <td colSpan={6} className="px-5 py-12 text-center text-slate-400 font-medium">Search된 정보가 없습니다.</td>
                                        </tr>
                                    )}
                                </tbody>
                            </table>
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                        <div>
                            <h1 className="text-2xl font-black text-amber-600 flex items-center gap-2">
                                ...
                                Regional/Client Sales Analytics (Company Analytics)
                            </h1>
                            <p className="text-slate-500 text-[15px] mt-1 tracking-tight">
