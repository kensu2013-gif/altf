...
export function PreviewModal({ htmlContent, onClose, onSend, onPrint, onOrder, docType = 'QUOTATION', memo, onMemoChange, hidePrint, hideClose }: PreviewModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-[9999] pointer-events-auto flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
